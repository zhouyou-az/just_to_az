...
function openLetter() {
  if (flag) {
    ...
    tl.to(".letter", 0.1, { x: 0, y: -200, rotationX: 0,scaleY: 1, delay: 0, ease: Circ.easeInOut });
    flag = false;
    ...
    tl2.to(".upper", 0.3, { x: 0, transformOrigin: "50% 100%", rotationX: 0, delay: 0, height: 125, ease: Circ.easeIn });
    tl2.to(".letter", 2, { x: 0, y: 0, rotationX: 0, scaleY: 0.5, delay: 0, ease: Expo.easeOut });
    tl2.to(".topfold", 2, { transformOrigin: "50% 0%", scaleY: 1, delay: 0, ease: Circ.easeIn })
    flag = true;
  }
